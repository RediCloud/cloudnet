...
public final class MultiPaperPermissionHelper {
  ...
  private MultiPaperPermissionHelper() {
  ...
  public static void injectPlayer(
    ...
    PERMISSIBLE_ACCESSOR.setValue(
      player,
      new MultiPaperCloudPermissionsPermissible(player, permissionManagement, wrapperConfiguration));
  }
