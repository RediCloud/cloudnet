...
package eu.cloudnetservice.modules.cloudperms.multipaper.listener;

import eu.cloudnetservice.driver.permission.PermissionManagement;
import eu.cloudnetservice.modules.cloudperms.CloudPermissionsHelper;
import eu.cloudnetservice.modules.cloudperms.multipaper.MultiPaperPermissionHelper;
...
@Singleton
public final class MultiPaperCloudPermissionsPlayerListener implements Listener {

  private final WrapperConfiguration wrapperConfiguration;
  private final PermissionManagement permissionsManagement;

  @Inject
  public MultiPaperCloudPermissionsPlayerListener(
  ...
  public void handle(@NonNull PlayerLoginEvent event) {
    if (event.getResult() == PlayerLoginEvent.Result.ALLOWED) {
      MultiPaperPermissionHelper.injectPlayer(event.getPlayer(), this.wrapperConfiguration, this.permissionsManagement);
    }
  }
