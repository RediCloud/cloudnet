...
package eu.cloudnetservice.modules.signs.platform.multipaper.event;
...
public class MultiPaperCloudSignInteractEvent extends PlayerEvent implements Cancellable {
  ...
  public MultiPaperCloudSignInteractEvent(@NonNull Player who, @NonNull PlatformSign<Player, String> clickedSign) {
    super(who);
