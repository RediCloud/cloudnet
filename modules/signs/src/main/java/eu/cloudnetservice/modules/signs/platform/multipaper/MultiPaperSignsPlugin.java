...
package eu.cloudnetservice.modules.signs.platform.multipaper;
...
import eu.cloudnetservice.modules.signs.platform.multipaper.functionality.SignInteractListener;
import eu.cloudnetservice.modules.signs.platform.multipaper.functionality.SignsCommand;
...
@PlatformPlugin(
  ...
  description = "MultiPaper extension for the CloudNet runtime which adds sign connector support",
...
public class MultiPaperSignsPlugin implements PlatformEntrypoint {
  ...
  private final MultiPaperSignManagement signManagement;
  private final SignInteractListener signInteractListener;

  @Inject
  public MultiPaperSignsPlugin(
    @NonNull JavaPlugin plugin,
    @NonNull SignsCommand signsCommand,
    @NonNull ModuleHelper moduleHelper,
    @NonNull PluginManager pluginManager,
    @NonNull ServiceRegistry serviceRegistry,
    @NonNull MultiPaperSignManagement signManagement,
