...
@Singleton
@ProvidesFor(platform = "multipaper", types = {PlatformBridgeManagement.class, BridgeManagement.class})
final class MultiPaperBridgeManagement extends PlatformBridgeManagement<Player, NetworkPlayerServerInfo> {
  ...
  @Inject
  public MultiPaperBridgeManagement(
    ...
    this.server = server;
    this.plugin = plugin;
    this.directGlobalExecutor = new MultiPaperDirectPlayerExecutor(
      plugin,
  ...
  public @NonNull PlayerExecutor directPlayerExecutor(@NonNull UUID uniqueId) {
    return uniqueId.equals(PlayerExecutor.GLOBAL_UNIQUE_ID)
      ...
      : new MultiPaperDirectPlayerExecutor(
        this.plugin,
        uniqueId,
