...
final class MultiPaperPluginInfoGenerator extends NightConfigInfoGenerator {
  ...
  public MultiPaperPluginInfoGenerator() {
    super(YamlFormat.defaultInstance(), "plugin.multi_paper.yml");
  }
