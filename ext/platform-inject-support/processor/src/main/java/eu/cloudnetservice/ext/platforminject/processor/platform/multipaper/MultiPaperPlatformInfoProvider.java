...
package eu.cloudnetservice.ext.platforminject.processor.platform.multipaper;
...
public final class MultiPaperPlatformInfoProvider extends PlatformDataGeneratorProvider {

  public MultiPaperPlatformInfoProvider() {
    super(
      "multipaper",
      MultiPaperPluginInfoGenerator::new,
      MultiPaperMainClassGenerator::new,
