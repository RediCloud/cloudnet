...
@Singleton
public class MultiPaperServiceConfigurationPreparer extends AbstractServiceConfigurationPreparer {

  @Inject
  public MultiPaperServiceConfigurationPreparer(@NonNull ServiceTaskProvider taskProvider) {
    super(taskProvider);
  }

  @Override
  public void configure(@NonNull CloudService cloudService) {
    if (cloudService.serviceId().taskServiceId() == 1) { // if the service is the master, there are no server.props...
      return;
    }
