...
import eu.cloudnetservice.node.service.defaults.config.MultiPaperServiceConfigurationPreparer;
...
public class DefaultCloudServiceManager implements CloudServiceManager {
  ...
  public DefaultCloudServiceManager(
    ...
    this.addServicePreparer(ServiceEnvironmentType.MULTI_PAPER, MultiPaperServiceConfigurationPreparer.class);
